...
export function SectionHeadingEditor({ 
  ...
  return (
    <h3 
      className="section-heading my-4 py-2 text-scripture-accent font-ui text-lg font-semibold
                 border-b border-scripture-border cursor-pointer hover:text-scripture-text
                 transition-colors"
