              ...
              {!showCreateNew ? (
                <>
                  ...
                  <button
                    ...
                    className="w-full px-4 py-2 text-sm bg-scripture-elevated text-scripture-text border border-scripture-border/50 rounded hover:bg-scripture-border/50 transition-colors"
                  >
                    + Create New List
                  </button>
                </>
