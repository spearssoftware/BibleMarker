...
export function ToolbarOverlay({ children }: ToolbarOverlayProps) {
  return (
    <div 
      className="animate-slide-up flex flex-col max-h-[50vh] overflow-hidden flex-shrink-0"
      ...
      aria-modal="true"
    >
      <div className="bg-scripture-surface shadow-lg flex-1 min-h-0 flex flex-col overflow-hidden mx-2 my-2 rounded-xl">
        {children}
      </div>
    </div>
  );
