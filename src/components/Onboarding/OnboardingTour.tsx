...
const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    description: 'Use the toolbar to mark text with highlights, colors, underlines, and symbols. Press number keys 1-6 for quick access.',
  ...
  },
  {
    id: 'keywords',
    title: 'Key Words',
    description: 'Define key words to automatically highlight across translations. Access from the toolbar (🔑 icon or press 4).',
  ...
  },
  {
    id: 'study-tools',
    title: 'Study Tools',
    description: 'View chapter summaries, book overviews, theme tracking, and observation lists. Access from the toolbar (📚 icon or press 5).',
