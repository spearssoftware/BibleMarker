...
const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    id: 'reading',
    title: 'Bible Reading',
    description: 'Read Scripture here. Select text to highlight, mark, or add notes. Click verse numbers to add notes or view cross-references.',
  ...
  },
  {
    ...
    description: 'Use the toolbar to access key words, study tools, and settings. All text marking is done through keywords for consistency across translations.',
  ...
  },
  {
    id: 'keywords',
    title: 'Key Words',
    description: 'Define key words to automatically highlight across translations. All text marking uses keywords. Access from the toolbar (🔑 icon or press 1).',
  ...
  },
  {
    id: 'study-tools',
    title: 'Study Tools',
    description: 'View chapter summaries, book overviews, theme tracking, and observation lists. Access from the toolbar (📚 icon or press 2).',
  ...
  },
  {
    id: 'settings',
    title: 'Settings',
    description: 'Configure translations, appearance, backup/restore, and more. Access from the toolbar (⚙️ icon).',
