...
export const SYMBOL_CATEGORY_MAP: Record<SymbolKey, KeyWordCategory> = {
  ...
  star: 'themes', starOutline: 'themes', heart: 'themes', lightning: 'themes', skull: 'themes', shield: 'themes', scales: 'themes', key: 'themes', sun: 'themes', moon: 'themes', cup: 'themes', sword: 'themes', warning: 'themes', joy: 'themes', peace: 'themes', mercy: 'themes', wisdom: 'themes', repentance: 'actions', praise: 'themes', glory: 'themes',
  ...
  mapPin: 'places', mountain: 'places', globe: 'places', tree: 'places', river: 'places', house: 'places', temple: 'places', church: 'places', city: 'places',
