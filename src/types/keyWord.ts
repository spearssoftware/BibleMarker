...
export const SYMBOL_CATEGORY_MAP: Record<SymbolKey, KeyWordCategory> = {
  triangle: 'identity', cross: 'identity', dove: 'identity', flame: 'identity', angel: 'identity', anchor: 'identity', cloud: 'identity',
  person: 'people', peopleGroup: 'people', crown: 'people', prayer: 'people', shepherd: 'people', child: 'people',
  obey: 'actions', chains: 'themes', liberty: 'themes', nationLand: 'places',
  star: 'themes', heart: 'themes', lightning: 'themes', gavel: 'themes', skull: 'themes', shield: 'themes', scales: 'themes', key: 'themes', sun: 'themes', moon: 'themes', cup: 'themes', sword: 'themes', warning: 'themes', warningDiamond: 'themes', idol: 'themes', joy: 'themes', peace: 'themes', mercy: 'themes', wisdom: 'themes', repentance: 'actions', praise: 'themes', glory: 'themes',
  righteous: 'themes', good: 'themes', will: 'themes', salvation: 'themes', holiness: 'themes', forgiveness: 'themes', blessing: 'themes', wrath: 'themes', sacrifice: 'themes', resurrection: 'themes', money: 'themes', covenant: 'themes',
  scroll: 'themes', book: 'themes', tablet: 'themes', lamp: 'themes', knowledge: 'themes',
  clock: 'time', calendar: 'time', hourglass: 'time', arrowRight: 'conclusions', arrowLeft: 'time', doubleArrow: 'contrasts', return: 'time',
  mapPin: 'places', mountain: 'places', globe: 'places', tree: 'places', river: 'places', house: 'places', temple: 'places', church: 'places', city: 'places', starOfDavid: 'places', heaven: 'places', tabernacle: 'places',
  ...
  sin: 'themes', vine: 'themes', bread: 'themes', door: 'themes', harvest: 'themes', fruit: 'themes',
