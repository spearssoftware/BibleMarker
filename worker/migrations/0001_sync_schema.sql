...
-- Email-OTP sign-in codes. email_hash is the PRIMARY KEY so "one active code
-- per email" is a DB invariant (a new request upserts the row), and avoids
-- storing raw emails for unverified attempts.
CREATE TABLE IF NOT EXISTS otp_codes (
  email_hash TEXT PRIMARY KEY,        -- SHA-256 hex of the lowercased email
